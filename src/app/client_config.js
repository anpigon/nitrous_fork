...
export const APP_NAME = 'Road Of Rich STEEM';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'Road Of Rich STEEM';
export const APP_NAME_UPPERCASE = 'RORS';
export const APP_ICON = 'rors';
// FIXME figure out best way to do this on both client and server from env
// vars. client should read $STM_Config, server should read config package.
export const APP_URL = 'https://www.steemit.com';
export const APP_DOMAIN = 'www.steemit.com';
export const SCOT_TAG = 'rors';
export const TAG_LIST = List(['rors']);
export const LIQUID_TOKEN = 'RORS';
// sometimes it's impossible to use html tags to style coin name, hence usage of _UPPERCASE modifier
export const LIQUID_TOKEN_UPPERCASE = 'RORS';
export const SCOT_DENOM = 100000000;
export const VOTE_WEIGHT_DROPDOWN_THRESHOLD = 1;
export const VESTING_TOKEN = 'RORS POWER';
